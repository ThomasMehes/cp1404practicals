...
# TO DO: list comprehension to create a list of all the full_names in lowercase format
lowercase_full_names = [item.lower() for item in full_names]
print(lowercase_full_names)

almost_numbers = ['0', '10', '21', '3', '-7', '88', '9']
# TO DO: list comprehension to create a list of integers from the above list of strings
numbers = [int(number) for number in almost_numbers]
print(numbers)

# TO DO: list comprehension to create a list of only the numbers that are
# greater than 9 from the numbers (not strings) you just created
numbers_greater_than_9 = [int(number) for number in almost_numbers if int(number) > 9]
print(numbers_greater_than_9)

# TO DO: (more advanced) use a list comprehension and the join string method
...
comma_seperated_string = ', '.join(long_names)
