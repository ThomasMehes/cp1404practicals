...
Password checker "skeleton" code was provided to help get started
The programs purpose is to get user to create a password within initial restrictions including special characters
If the password doesn't pass, the user input is continually taken until it is and returned to user.
"""
